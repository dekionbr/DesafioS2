...
using AmigoCrud.S2.Infra.CrossCutting.Identity.Extensions;
using AmigoCrud.S2.Infra.CrossCutting.Identity.Models;
using AmigoCrud.S2.Infra.CrossCutting.Identity.Models.AccountViewModels;
using AmigoCrud.S2.Infra.CrossCutting.Identity.Services;
using AmigoCrud.S2.UI.WebSite.Extensions;
        ...
        public async Task<IActionResult> Register(RegisterViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await _userManager.AddClaimAsync(user, new Claim("Jogos", "Write"));
        ...
        public async Task<IActionResult> ExternalLoginConfirmation(ExternalLoginViewModel model, string returnUrl = null)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    {
                        // User claim for write customers data
                        await _userManager.AddClaimAsync(user, new Claim("Amigos", "Write"));
